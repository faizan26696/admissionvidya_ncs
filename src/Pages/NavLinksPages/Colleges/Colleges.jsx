...
const Colleges = () => {
  ...
  const handleInputChange = (e) => {
    ...
    // If the input value becomes empty, show all colleges
    if (val === "") {
      setSelectedCollege(null); // Reset the selected college
      setShowList(false);
      setSearchTerm("");
    } else {
      setSearchTerm(val);
  ...
  const handleInputBlur = () => {
    // Delay the hiding of the list to ensure click events are processed
    setTimeout(() => {
      setShowList(false);
    }, 200);
  };
    ...
    <div className="relative">
      ...
      <div className="w-full min-h-screen flex flex-col items-center justify-center">
        <div className="text-center   md:w-1/3 relative">
          ...
          {showList && (
            <div className="mt-2 text-left absolute  w-full bg-white p-6 rounded-lg   shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px]">
        ...
        <div className="w-full sm:w-[75%] min-h-screen flex items-center justify-center">
          <div className="px-4 flex justify-center flex-col max-w-[800px] w-full">
            ...
            >
              {selectedCollege ? (
                // Display details of the selected college
                <div className="mt-[5px] rounded-lg border flex flex-col md:flex-row justify-center sm:justify-between items-center sm:items-start border-gray-100 bg-[#F8F8FF] p-4 shadow-sm transition hover:shadow-lg sm:p-6">
